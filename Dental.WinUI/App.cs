...
public class App : BaseApp
{
    ...
    public App(IServiceProvider serviceProvider, IGraphicsService graphicsService, ILogger<App> logger)
    ...
    private unsafe void InitializeDepthStencils()
    {
        ...
        device.CreateDepthStencilState( depthStencilDisabledDesc, ref depthStencilDisabledState.GetPinnableReference())
            .ThrowHResult();
